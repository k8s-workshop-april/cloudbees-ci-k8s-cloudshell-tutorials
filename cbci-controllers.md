...
```bsh
echo https://deon-cloudbees.workshop.cb-sa.io/cjoc/
```
...
curl --user "admin:$CJOC_ADMIN_API_TOKEN" -XPOST \
              https://deon-cloudbees.workshop.cb-sa.io/cjoc/casc-items/create-items \
...
gcloud container clusters delete deon-cloudbees --region=us-east1 --async
