...
gcloud container clusters create "deon-cloudbees" \
    --region "us-east1" \
...
CBCI_HOSTNAME=deon-cloudbees.workshop.cb-sa.io
...
```bsh
ping deon-cloudbees.workshop.cb-sa.io
```
...
The Operations Center for your CloudBees CI cluster should be running or starting up, and available at: [http://deon-cloudbees.workshop.cb-sa.io]/cjoc](http://deon-cloudbees.workshop.cb-sa.io]/cjoc])
